...
const AcceptedRejectedRidesHeader = ({ onRouteChange }) => {
    return (
        <div>
            ...
            <div >
                ...
                <legend className="f3 fw6 ph0 mh0">Rides</legend>
                ...
                <table className="f6 w-100 ph4 mw8 center bg-white" cellSpacing="2">
                    <thead>
                        <tr className="stripe-dark">
                            ...
                            <th className="fw6 tl pa3 bg-white right">Ride Status</th>
                        </tr>
                    </thead>
                </table>
...
export default AcceptedRejectedRidesHeader;